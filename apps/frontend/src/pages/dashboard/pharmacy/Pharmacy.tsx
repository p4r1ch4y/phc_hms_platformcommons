        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500">Manage medicines, stock levels, and expiry dates.</p>
                </div>
                <Link
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                {loading ? (
                    ...
                    <div className="p-12 text-center">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-slate-900">No medicines found</h3>
                        <p className="mt-1 text-sm text-slate-500">Get started by adding new stock.</p>
                    </div>
                ) : (
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500">{item.manufacturer} • {item.unit}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="text-right">
                                            <div className="text-sm font-medium text-slate-900">{item.totalStock} {item.unit}s</div>
