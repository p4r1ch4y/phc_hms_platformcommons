    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-slate-500">Manage your account and PHC preferences.</p>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div className="text-slate-900 font-medium">{user.name || user.firstName + ' ' + user.lastName}</div>
                    </div>
                    <div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-500 mb-1">Tenant ID</label>
                        <div className="text-slate-500 font-mono text-xs">{user.tenantId || 'N/A'}</div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="p-6 space-y-6">
                        <div>
                            ...
                            <button
                                ...
                                disabled={seeding}
                                className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50"
                            >
                                {seeding ? (
                                    <>
                            ...
                            {seedStatus && (
                                <div className={`mt-4 p-4 rounded-lg flex items-start gap-3 ${seedStatus.type === 'success' ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'
                                    }`}>
