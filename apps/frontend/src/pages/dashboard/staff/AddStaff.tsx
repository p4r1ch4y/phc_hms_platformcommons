    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Add Staff Member</h1>
                    <p className="text-slate-500 dark:text-slate-400">Create a new account for your PHC team.</p>
                </div>
            </div>
