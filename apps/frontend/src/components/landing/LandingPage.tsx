    ...
    return (
        <div className="min-h-screen flex flex-col font-sans">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-heading font-bold text-xl text-slate-900">PHC Commons</span>
                        </div>
                        <div className="hidden md:flex items-center gap-8">
                            <a href="#features" className="text-slate-600 hover:text-primary-600 font-medium">Features</a>
                            <a href="#workflow" className="text-slate-600 hover:text-primary-600 font-medium">Workflow</a>
                            <a href="#team" className="text-slate-600 hover:text-primary-600 font-medium">Team</a>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <Link to="/register" className="bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-8 py-3.5 rounded-xl font-semibold transition-all flex items-center justify-center">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
                                ...
                                <div className="p-6 grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2 bg-white border border-slate-100 rounded-xl p-4 shadow-sm">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">The Reality of Rural Healthcare</h2>
            ...
            <section id="features" className="py-20 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-2">End-to-End Hospital Management</h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:border-primary-300 transition-colors group">
            ...
            <section id="team" className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">Empowering Every Team Member</h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h3 className="font-bold text-lg text-slate-900">Doctor</h3>
                                <p className="text-slate-600 mt-1">See patient history instantly. Prescribe with AI checks for drug interactions.</p>
                            </div>
                        </div>
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h3 className="font-bold text-lg text-slate-900">Nurse</h3>
                                <p className="text-slate-600 mt-1">Faster vitals recording. Automated alerts for high-risk patients.</p>
                            </div>
                        </div>
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h3 className="font-bold text-lg text-slate-900">ASHA Worker</h3>
                                <p className="text-slate-600 mt-1">Field data collection on mobile. Syncs automatically with the PHC.</p>
                            </div>
                        </div>
                    </div>
                </div>
